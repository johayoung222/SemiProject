...
div#search-memberLoginlog{
	display: <%="memberLoginlog".equals(searchType)?"inline-block":"none"%>;
}
</style>
<script>
$(function(){
...
<h2>회원 리스트</h2>	
		...
		<select id="searchType">
			...
			<option value="memberLoginlog" <%="memberLoginlog".equals(searchType)?"selected":"" %>>로그인횟수</option>
		</select>
		&nbsp;
