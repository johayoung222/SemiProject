 ...
 * Generated at: 2019-01-15 11:03:06 UTC
...
public final class monthlySchedule_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/common/side.jsp", Long.valueOf(1547549955395L));
  }
...
if(memberLoggedIn != null){ 
	...
	if(memberLoggedIn1 == null) {
      ...
      out.write("\t\t<a href=\"#\" class=\"font\" id=\"yearSchedule\">년간 스케줄</a><hr />\r\n");
      out.write("\t\t<a href=\"");
      out.print(request.getContextPath());
 ...
 for(int i = 0;i < friendList.size();i++) { 
      ...
      out.write("\t\t\t\r\n");
      out.write("\t\t\tconsole.log(JSON.parse(data).response.body.items.item);\r\n");
      out.write("\t\t\tconsole.log(\"type=\"+(JSON.parse(data).response.body.items.item).length);\r\n");
      out.write("\t\t\t  \r\n");
      ...
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\tconsole.log(JSON.parse(data).response.body.items[i].locdate);\r\n");
      out.write("\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tconsole.log(copymonth);\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\tconsole.log(JSON.parse(data).response.body.items.item[i].locdate);\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\tvar comp = copymonth.substring(6,8);\r\n");
      out.write("\t\t\t\t\tvar compa = comp.substring(0,1);\r\n");
      out.write("\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th style=\"color:red;border-left:3px solid black;\">일</th>\r\n");
      out.write("\t\t\t\t<th>월</th>\r\n");
      out.write("\t\t\t\t<th>화</th>\r\n");
      out.write("\t\t\t\t<th>수</th>\r\n");
      out.write("\t\t\t\t<th>목</th>\r\n");
      out.write("\t\t\t\t<th>금</th>\r\n");
      out.write("\t\t\t\t<th style=\"color:blue;border-right:3px solid black;\">토</th>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
 ...
 for(int i=1; i<=31; i++){
      ...
      out.write("\t\t\tif(scrollTop > 0.5){\r\n");
      out.write("\t\t\t\t$(\"#year-box\").css(\"display\",\"block\");\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\t$(\"#year-box\").css(\"display\",\"none\");\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t});   */   \r\n");
      out.write("\t\t/* flag = 0;\r\n");
      out.write("\t\twindow.addEventListener('scroll',function(e){\r\n");
      out.write("\t\t\tconsole.log(\"scrolled!!\");\r\n");
      out.write("\t\t\tif(flag == 0){\r\n");
      out.write("\t\t\t\t$(\"#year-box\").css(\"display\",\"block\");\r\n");
      out.write("\t\t\t\tflag = 1;\r\n");
      out.write("\t\t\t}else{\r\n");
